...
class GetPokemon
{
    private $pokemonList = [
        ...
        'Chansey', 'Tangela', 'Kangaskhan', 'Horsea', 'Seadra', 'Goldeen', 'Seaking', 'Staryu', 'Starmie', 'Mr. Mime',
    ...
    {
        $max = count($this->pokemonList);
        $pos = rand(1, $max);

        return $this->pokemonList[$pos];
    }
}
